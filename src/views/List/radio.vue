...
const playAllSongs = debounce(() => {
  ...
  const listToPlay = searchValue.value && searchData.value?.length ? searchData.value : radioListData.value;
  player.updatePlayList(listToPlay, undefined, radioId.value);
}, 300);
